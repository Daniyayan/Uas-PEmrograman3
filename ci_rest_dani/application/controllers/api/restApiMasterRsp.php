...
class restApiMasterRsp extends REST_Controller 
{
    protected $table;
    protected $column;
    ...
    public function __construct() {
        ...
        $this->table      = "tbl_resep"; // ganti jika ingin menambahklan controller baru
    ...
    public function mrRsp_post() {
        $id_pasien              = $this->post('id_pasien');
        $id_dokter              = $this->post('id_dokter');
        $tanggal_resep          = $this->post('tanggal_resep');
        $nama_obat              = $this->post('nama_obat');
        $jenis_obat             = $this->post('jenis_obat');
        $keterangan             = $this->post('keterangan');

        // Cek jika data yang di input kosong
        if ( $id_pasien == null || $id_dokter == null || $jenis_obat == null || $tanggal_resep == null || $nama_obat == null || $keterangan ==null) {
            $this->response(
                [
                    'response_code' => $this->msgBadReq,
                    'status'        => false,
    ...
    public function mrRsp_put() {
        
        $id_pasien         = $this->put('id_pasien');
        $id_dokter      = $this->put('id_dokter');
        $tanggal_resep         = $this->put('tanggal_resep');
